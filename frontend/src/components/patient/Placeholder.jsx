...
export default function Placeholder({ title, Icon }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-95 gap-3">
      <div className="w-13.5 h-13.5 rounded-[13px] bg-[hsl(196,64%,88%)] flex items-center justify-center">
